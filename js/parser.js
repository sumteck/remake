...
const TbrParser = (() => {
  ...
  function _extractTreasury(text) {
    // 'Treasury' എന്ന് മാത്രം കൊടുക്കാതെ 'Name Of Treasury' എന്ന് കൃത്യമായി തുടങ്ങുന്ന വരി മാത്രം എടുക്കുന്നു
    const m = text.match(/Name\s*Of\s*Treasury\s*[:\-]?\s*([^\n\r]+)/i);
    
    if (m) {
      // ട്രഷറി പേരിനൊപ്പം അനാവശ്യമായി വരാൻ സാധ്യതയുള്ള വാക്കുകൾ കട്ട് ചെയ്ത് മാറ്റുന്നു

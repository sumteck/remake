...
// =========================================================================
 ...
 function _extractBimsDetails(text) {
    ...
    // 2. Treasury എടുക്കാനുള്ള ഫൈനൽ ലോഗിക്: 
    // Sub/District എന്നൊന്നും നോക്കാതെ, കോളനിൽ (:) തുടങ്ങി Treasury എന്ന വാക്ക് വരുന്ന വരി മുഴുവനായി എടുക്കുന്നു!
    const trMatch = text.match(/:\s*([^:\n]*Treasury[^\n]*)/i);

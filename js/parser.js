...
// =========================================================================
 ...
 function _extractBimsDetails(text) {
  ...
  async function parseBimsBillFull(file) {
    ...
    // ക്ലോഡ് ശരിയാക്കി തന്ന ഫംഗ്ഷൻ വഴി ഡാറ്റ എടുക്കുന്നു
    ...
    // ഇതാണ് താങ്കൾ ചോദിച്ച മാറ്റം: Department-ഉം Office-ഉം ഒന്നിച്ച് ചേർക്കുന്നു!
    ...
    return {
      ...
      // ആ കോളം ഇവിടെ ടേബിളിലേക്ക് കൊടുക്കുന്നു
